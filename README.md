...
- [**Ouroboros**](https://github.com/razzant/ouroboros) - General-purpose AI agent with persistent identity and memory, reviewed self-modification, and desktop and CLI interfaces. by [@razzant](https://github.com/razzant) (1,234 stars)
